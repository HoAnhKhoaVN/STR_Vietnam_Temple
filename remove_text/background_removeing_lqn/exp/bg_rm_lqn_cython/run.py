...
def run_code_cython():
    ...
    # )
    s = time()
    BR, J = code_cython.bg_rm_lqn(
        I = 255-I,
    )
    e = time()
    print(f"Time remove background with code cython: {e-s} s")
...
def run_compute_memory():
    image_fn= 'D:/Master/OCR_Nom/fulllow_ocr_temple/remove_text/background_removeing_lqn/test.png'
    addition_fn= 'compute_memview'
    ROOT = 'D:/Master/OCR_Nom/fulllow_ocr_temple/remove_text/background_removeing_lqn/exp/bg_rm_lqn_cython'
    # image_fn = '35227268_1442578812555603_8324419005091676160_n.jpg'
    # image_fn = 'test_2.png'
    # image_fn = 'test_3.png'
    ...
    # )
    s = time()
    BR, J = compute_memview.bg_rm_lqn(
        I = 255-I,
    )
    e = time()
    print(f"Time remove background with compute memview: {e-s} s")
